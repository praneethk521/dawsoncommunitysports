// Updated Dawson Community Sports 2025 React App with Dark Mode Toggle

import React, { useEffect, useState } from 'react';
import './index.css';
import logo from '../public/logo.png'; // Path to the uploaded logo
  ...
  return (
    <div className={`${darkMode ? 'dark' : ''}`}>
      <div className="font-sans text-gray-800 dark:text-gray-100 min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
        ...
        {activeTab === 'home' ? <HomeContent /> : <Leaderboard data={leaderboardData} />}
...
const EventCard = ({ title, category, type, date }: { title: string; category: string; type: string; date: string }) => (
  <div className="border rounded-lg p-4 shadow-md bg-white dark:bg-gray-700 dark:text-white hover:shadow-lg transition-all duration-300">
